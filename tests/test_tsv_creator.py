...
class TestCsvCreator(unittest.TestCase):
    ...
    def test_create(self):
        ...
        expected_output = (
            '"Test Title 1"\t"Test Author 1"\t"2021"\t"Test Description 1"\t"Test Label 1"\t"Humble Bundle"\t"PDF, EPUB"\n'
            '"Test Title 2"\t"Test Author 2"\t"2020"\t"Test Description 2"\t"Test Label 2, Test Label 3"\t"Humble Bundle"\t"PDF"\n'
            '"Test Title 3"\t"Test Author 3"\t""\t"Test Description 3 "\t""\t"Humble Bundle"\t"PDF, EPUB, MOBI"\n'
        )
