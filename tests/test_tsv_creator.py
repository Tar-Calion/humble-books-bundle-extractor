...
class TestCsvCreator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.books = [
            Book("Test Title 1", "Test Author 1", "Test Description 1", 2021, formats=["PDF", "EPUB"],
                 labels=["Test Label 1"], purchase_date="01-01-2021"),
            Book("Test Title 2", "Test Author 2", "Test Description 2", 2020, formats=["PDF"],
                 labels=["Test Label 2", "Test Label 3"], purchase_date="01-01-2021"),
    ...
    def test_create(self):
        ...
        expected_output = (
            '"Test Title 1"\t"Test Author 1"\t"2021"\t"Test Description 1"\t"Test Label 1"\t"Humble Bundle"\t"PDF, EPUB"\t"01-01-2021"\n'
            '"Test Title 2"\t"Test Author 2"\t"2020"\t"Test Description 2"\t"Test Label 2, Test Label 3"\t"Humble Bundle"\t"PDF"\t"01-01-2021"\n'
            '"Test Title 3"\t"Test Author 3"\t""\t"Test Description 3 "\t""\t"Humble Bundle"\t"PDF, EPUB, MOBI"\t"01-01-2021"\n'
        )
